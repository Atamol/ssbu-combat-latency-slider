...
pub static LOC_UPDATE_ROOM: SSBUMemoryLocation = SSBUMemoryLocation {
    signature: &[
        // Truncated before the first ADRP, whose immediate moves whenever rodata does
        ...
        0x03, 0x00, 0x32, 0x0a, 0x69, 0x29, 0x38,
    ],
    start_offset: 0,
...
pub static LOC_UPDATE_CSS: SSBUMemoryLocation = SSBUMemoryLocation {
    signature: &[
        // Truncated before the first BL, whose immediate moves whenever the callee does
        ...
        0x08, 0x01, 0x40, 0xf9, 0x00, 0x01, 0x40, 0xf9, 0xe1, 0x03, 0x00, 0x32,
    ],
    start_offset: 0,
